...
Este archivo contiene las soluciones de todos los ejercicios. **NO MOSTRAR A LOS ESTUDIANTES HASTA DESPUÉS DE LA ENTREGA.**
...
def currency():
    ...
    print(dolares)        # 28.571428571428573
    print(euros)          # 26.31578947368421
    print(reales)         # 142.85714285714286
```
